...
def get_training_dataloader(root_path='datasets/train', batch_size=16, num_workers=2, shuffle=True, size=(128, 128)):
...
def get_valid_dataloader(root_path='datasets/val', batch_size=16, num_workers=2, shuffle=True, size=(128, 128)):
...
def get_test_dataloader(root_path='datasets/test', batch_size=16, num_workers=2, shuffle=True, size=(128, 128)):
...
def time_wrapper(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        print('run {0:<1} spend : {1:<8}secs'.format(func.__name__, end-start))
