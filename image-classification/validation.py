...
""" validation neuron network performace
print top1 and top5 err on validation dataset
of a model
...
if __name__ == '__main__':
    ...
    parser.add_argument('-weights', type=str, required=True, help='the weights file you want to validation')
    ...
    with torch.no_grad():
        for n_iter, (image, label) in enumerate(valid_loader):
            print("iteration: {}\ttotal {} iterations".format(n_iter + 1, len(valid_loader)))
